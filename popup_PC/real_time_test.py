...
def listen_print_loop(responses):
    """Iterates through serveudo apt-get install portaudio19-dev python-pyaudio python3-pyaudior responses and prints them.
    ...
    for response in responses:
        ...
        if not result.is_final:
            ...
            #     print("Exiting..")
            #     break
            if re.search(r"\b(종료|끝)\b", transcript):
                print("Exiting..")
                break
            pub_dialogflow.talker(transcript + overwrite_chars)
...
def main():
    ...
    # playsound("/home/kist/catkin_ws/src/pop_up_space/scripts/open.mp3")
